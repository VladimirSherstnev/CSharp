...
int deep1 = InputInt2("Введите размерность 1: ");
int deep2 = InputInt2("Введите размерность 2: ");
int deep3 = InputInt2("Введите размерность 3: ");
int countNums = 890;
...
int[,] nums = new int[size2, size2];

int number = 1;
int numberi = 0;
int numberj = 0;

while (number <= size2 * size2)
{
    nums[numberi, numberj] = number;
    if (numberi <= numberj + 1 && numberi + numberj < size2 - 1)
        ++numberj;
    else if (numberi < numberj && numberi + numberj >= size2 - 1)
        ++numberi;
    else if (numberi >= numberj && numberi + numberj > size2 - 1)
        --numberj;
    else
